...
use crate::{
    JsonObject, MessageId, ToolCallId,
    llm::{AssistantContent, StopReason, Usage},
    models::ModelRef,
...
pub struct AssistantMessage {
    ...
    pub duration_ms: u64,
    /// Unmodified provider response. This field is intentionally required.
...
/// Application-owned message stored alongside LLM messages.
#[derive(Clone, Debug, Deserialize, JsonSchema, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
