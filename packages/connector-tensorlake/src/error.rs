...
#[derive(Debug, Error)]
pub enum TensorlakeConnectorError {
    #[error("Tensorlake connector configuration is invalid: {0}")]
    InvalidConfiguration(String),
    #[error(transparent)]
    Transport(#[from] TensorlakeTransportError),
}

#[derive(Clone, Debug, Error)]
#[error("{message}")]
pub struct TensorlakeTransportError {
    pub message: String,
    pub retryable: bool,
    pub disconnected: bool,
}

impl TensorlakeTransportError {
...
pub(crate) fn transport_execution_error(source: TensorlakeTransportError) -> ExecutionError {
    ExecutionError {
