...
#[derive(Clone)]
pub(crate) struct TensorlakeBackend {
...
#[async_trait]
impl WorkspaceQuery for TensorlakeBackend {
    async fn inspect(
        &self,
...
#[async_trait]
impl BasicFileSystem for TensorlakeBackend {
    async fn inspect(
        &self,
        context: &OperationContext,
        request: InspectRequest,
...
#[async_trait]
impl WorkspaceMutation for TensorlakeBackend {
    async fn prepare(
        &self,
        context: &OperationContext,
