...
impl InProcessCodeModeSession {
    ...
    pub fn with_delegate_and_state_store(
        delegate: Arc<dyn CodeModeSessionDelegate>,
        state_store: Arc<dyn CodeModeStateStore>,
    ) -> Self {
        Self::with_delegate_state_store_and_limits(
            delegate,
            state_store,
    ...
    pub fn with_delegate_state_store_and_limits(
        delegate: Arc<dyn CodeModeSessionDelegate>,
        state_store: Arc<dyn CodeModeStateStore>,
        cell_execution_limits: CodeModeSessionCellExecutionLimits,
    ) -> Self {
        Self {
            runtime: SessionRuntime::new_with_state_store_and_task_failure_handler(
