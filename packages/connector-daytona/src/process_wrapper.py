...
def acknowledge_control(command):
    control_id = command.get("control_id")
    if control_id:
        sys.stdout.write(json.dumps({"control_ack": control_id}, separators=(",", ":")) + "\n")
        sys.stdout.flush()
