...
fn fireworks_options(
    ...
    let reasoning_effort = fireworks_reasoning_effort(model_id, reasoning_level)
        .expect("every catalog Fireworks model has a mapping for every Pi reasoning level");
...
fn deepseek_options(
    ...
    let reasoning_effort = deepseek_reasoning_effort(model_id, reasoning_level)
        .expect("every catalog DeepSeek model has a mapping for every Pi reasoning level");
...
mod tests {
    ...
    #[test]
    fn maps_every_pi_reasoning_level_for_every_fireworks_model() {
        let expected = [
            (
    ...
    #[test]
    fn maps_every_pi_reasoning_level_for_every_deepseek_model() {
