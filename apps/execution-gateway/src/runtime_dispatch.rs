...
use execution_protocol::{Operation, Response, StreamItem};
...
pub async fn dispatch(
    ...
    let result = match operation {
        ...
        Operation::WorkspaceInspectMany(request) => DispatchResult::Unary(Response::InspectMany(
            runtime
                .workspace_query()
        ...
        Operation::MutationPrepare(request) => DispatchResult::Unary(Response::PreparedMutation(
            mutation(runtime)?.prepare(context, request).await?,
        )),
        ...
        Operation::ArtifactMetadata(request) => DispatchResult::Unary(Response::ArtifactMetadata(
            artifacts(runtime)?.metadata(context, request).await?,
        )),
        ...
        Operation::FilesystemWriteBytes(request) => DispatchResult::Unary(Response::WriteBytes(
            filesystem(runtime)?.write_bytes(context, request).await?,
        )),
