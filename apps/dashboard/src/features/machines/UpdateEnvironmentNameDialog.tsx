...
import {
  ...
  useUpdateMachineEnvironmentName,
} from './machine-queries'

type UpdateEnvironmentNameDialogProps = {
  environment: MachineEnvironment
  onClose: () => void
}

export function UpdateEnvironmentNameDialog({
  environment,
  onClose,
}: UpdateEnvironmentNameDialogProps) {
  const [name, setName] = useState(() => environment.name)
  const updateName = useUpdateMachineEnvironmentName()
