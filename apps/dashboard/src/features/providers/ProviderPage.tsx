  ...
  return (
    <div className="cursor-shell machine-detail-shell">
      ...
      <main className="cursor-main machine-detail-main">
        <div className="cursor-container provider-overview-page">
          ...
          >
            ...
            <div className="providers-table-wrap">
              <table className="providers-table provider-requests-table">
                ...
                <tbody aria-live="polite" aria-busy={requests.isPending}>
                  {requests.isPending ? (
...
function OverviewError({
  ...
  return (
    <div className="provider-overview-state" title={message}>
      <span>{label}</span>
